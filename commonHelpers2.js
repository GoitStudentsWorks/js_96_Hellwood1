import{d as p,m as h,c as f,b as m,E as S,r as L,e as u,f as y,i as d,g as w}from"./assets/header-modal-e02b16a5.js";import"./assets/vendor-c4bdd18a.js";const x=document.querySelector(".favorites-page"),b=document.querySelector(".header-section");b.classList.add("header-section-favorites");x.classList.add("active-page");p();h();f();m();const a=document.querySelector(".favorites-list");a.innerHTML='<span class="loader"></span>';const v=`<div class="favorites-no-results"><img
